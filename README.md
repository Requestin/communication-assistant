...
Однако, это ещё не коммерческий продукт.
...
- **Подбор поездки по заявке.** По кнопке сервис собирает вариант из справочника: рейсы туда и обратно, отель, ориентир по стоимости. Если клиент позже меняет даты, города или число людей, новый подбор опирается на последние условия — а не на первое письмо. Менеджер правит текст и отправляет сам.
