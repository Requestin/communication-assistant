...
Приветствие снижай только если в задании «Проверять приветствие: да».
Иначе не пиши про приветствие в issues/hint и не роняй businessStyle из‑за его отсутствия.
