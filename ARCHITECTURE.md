...
Низ колонки переписки (не низ документа): textarea, «Отправить», «Подобрать решение» закреплены внизу окна под шапкой сайта. История писем крутится только в ленте; список диалогов слева скроллится отдельно. Документ от длинной переписки не растёт.
